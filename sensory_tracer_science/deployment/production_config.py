...
class ProductionConfig:
    ...
    def _validate_configuration(self):
        ...
        if self.database.max_connections <= self.database.min_connections:
            validation_errors.append("Database max_connections must be > min_connections")
    ...
    def get_database_url(self) -> str:
        ...
        if not password:
            raise ValueError(f"Database password not found in {self.database.password_env_var}")
        
        return (f"postgresql://{self.database.username}:{password}@"
    ...
    def get_security_settings(self) -> Dict[str, Any]:
        ...
        if not jwt_secret:
            raise ValueError(f"JWT secret not found in {self.security.jwt_secret_env_var}")
    ...
    def export_config(self, output_path: str):
        ...
        config_dict['security']['compliance_level'] = self.security.compliance_level.value
